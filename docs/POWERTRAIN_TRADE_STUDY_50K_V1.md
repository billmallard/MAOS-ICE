...
## 11. v4/v5 — Weekly Market-Watch Delta (AER-59, 2026-08-23 + 2026-08-30)

Standing note: this master document's Combo 3 dollar figures are superseded by [AER-73](/AER/issues/AER-73)'s corrected-machine frontier (`COMBO3_SINGLE_MOTOR_FRONTIER_V1.md` — Package A, twin EMRAX 268 used/salvage, $57,200/14% over), not yet folded back here pending Bill's disposition on AER-56/AER-73. §11.1–11.2 are the 2026-08-23 pass; §11.3–11.5 are the 2026-08-30 pass, appended in place rather than as a new top-level section since the carrying PR (#19) had not yet been merged/reviewed. Neither pass re-derives §7-§10.

### 11.1 Closing Bill's APU / starter-generator lead (2026-08-11 comment on AER-56)

Bill flagged this on 2026-08-11 ("dig into the APU market... that and 'starter generators'"); it went unaddressed through five subsequent weekly wakes (2026-08-16 pass covered turboalternators/rim-drive/H3X/EMRAX/Hayabusa/batteries but not this). Run down this pass, sourced:

| Candidate class | Product(s) checked | Electrical output | Verdict against 96 kW cruise / 155 kW climb floor |
|---|---|---:|---|
| Small-aircraft APU | Honeywell RE100 (Learjet 45/Citation-class) | 17 SHP pad shaft (~13 kW mech.) — primarily bleed-air/pneumatic, not an electrical genset | Not close — wrong product category (ECS/start air, not power generation) |
| Small-aircraft APU | Honeywell RE220 | 25–50 kW electric, 100–300 kg | 26–52% of cruise floor, 16–32% of climb floor; mass alone (100–300 kg) rivals our whole genset budget |
| Helicopter/GA APU-GPU | PBS Saphir 5K/G-MI, Saphir 20 | 20–40 kVA rated, 60 kVA overload (~16–48 kW real) | 17–50% of cruise floor at overload; below floor at rated |
| Aviation starter-generator | Traditional 28V DC accessory-drive units (Skurka-class); "more-electric aircraft" high-speed PM starter-generator R&D (95 kW class) | 150–400A @ 28V (~4–11 kW) for the sourceable class; 95 kW figure is an embedded large-turbofan accessory-drive research design, not a purchasable GA part at any price | Wrong scale entirely (LV bus/engine-start duty) or not a real off-the-shelf product |

**Verdict: neither category qualifies, and both are closed with a documented negative rather than left open.** No APU in the small/light-aircraft class approaches our 96 kW continuous floor as a standalone electrical source — the class is designed to supply bleed air plus a modest cabin/systems electrical load, not primary flight propulsion power, and the largest unit found (PBS Saphir, 60 kVA overload) still falls short even before applying any continuous-duty derate. "Starter-generator" as an aviation term of art means an LV-bus accessory machine sized for engine start current draw (kW-class), not a propulsion-scale genset; the one 95 kW-class design found is a large-turbofan R&D accessory-drive integration, not a sourceable GA component. Consistent with the certified-aviation-hardware cost-lever pattern already in [[motor-generator]] memory: none of these carry public unit pricing — RE100/RE220 and PBS Saphir are quote-only, same thin-market pattern as DeltaHawk/Turbotech/AantFarm.

### 11.2 Frontier-hardware figures firmed up (no pricing gained)

- **Turbotech TP-R150** (already on the 2026-08-16 watchlist, then only a name): now confirmed **104 kW / 141 hp rated, 3,000 hr TBO, multi-fuel**, and reported moving from demonstrator to production across six light-aircraft programs in 2026 — a real maturity signal. Clears our 96 kW cruise floor on paper if the turbogenerator variant carries the same rating as the turboprop. **Still no standalone unit price** — the only figure found is a $690k full-aircraft price (Wasatch Carbon Cub ULT conversion), not decomposable to a drivetrain-only number. Stays unscored on missing price data, unchanged disposition from 2026-08-16.
- **H3X:** HPDM-500 (500 kW/50 kg) reported nearing commercial readiness with first units shipping later in 2026 — oversized for our need (climb floor is 155 kW) but a scale/maturity signal for the product line. Separately, HPDM-250 is reported to have demonstrated 180 kW in testing (vs. the lower figure previously catalogued) — **if that number turns out to be a continuous rating on the vendor's own datasheet, a single HPDM-250 would clear our 155 kW climb floor outright**, which would be a first for any candidate in this catalog. This is currently a single secondary-source (press/LinkedIn) claim, not a datasheet-sourced continuous rating — does not meet this catalog's evidence bar yet, flagged for a direct H3X datasheet pull next pass. No public pricing found anywhere in the H3X line, unchanged.
- **Duxion, RimThrust:** no material change from 2026-08-16 — Duxion remains regional-jet/cargo scale (the $500M CAD MOU is a 2022 commitment, not new), RimThrust still has no published kW or price data.
- **Hayabusa conversions, batteries, light diesel:** no new aircraft-specific project, pricing, or lever found this pass; standing 2026-08-16 figures unchanged, not re-derived.

### 11.3 H3X HPDM-250 — the flagged open item resolved, still unpriced (this pass, 2026-08-30)

The 2026-08-23 pass (§11.2) flagged the HPDM-250's 180 kW figure as an unresolved press/LinkedIn claim, not a vendor-stated continuous rating, and asked for a direct pull. Done this pass: **H3X's own company post states the 180 kW figure explicitly as "180 kW of continuous shaft power" on their in-house dynamometer, with the 6.7:1 gearbox fitted, at 18.7 kg total mass (9.6 kW/kg system-level specific power; 12.5 kW/kg for the bare motor without gearbox)** — this is a vendor-published test-cell result, not a datasheet spec-sheet line, but it is H3X's own words ("continuous"), which clears the evidentiary bar this catalog has been withholding credit for. **A single HPDM-250 at that rating clears our 155 kW climb floor outright, in an 18.7 kg package** — no other candidate in this catalog does that with one unit. **No pricing found anywhere in the H3X line, at any SKU, still.** This does not change the recommendation — an unpriced part cannot be scored into a combo — but it sharpens trigger (c) below: H3X is now the single most consequential vendor to watch for a price announcement, ahead of Duxion/Turbotech.

### 11.4 New candidate — Evolito E800 (axial-flux, CAA type-certification submitted 2026-07-20)

Not previously in this catalog. Evolito (UK) submitted the **E800** for CAA type certification on 2026-07-20 as the power unit for Electra's EL9 "Ultra Short" hybrid-electric aircraft — a real, named, in-development GA program, not a demonstrator. Sourced specs: **110 kW continuous @ 2,000 RPM, 800 Nm rated torque, 28.3 kg maximum weight (complete dry line-replaceable unit including prop bearing), 3,000 RPM transient**, liquid-cooled, integrated motor + DAL-A controls/inverter hardware and software in one LRU. That is 3.9 kW/kg continuous — in the same power-density class as EMRAX 268 (§0.1/§2, ~3.85 kW/kg for motor+controller) but with integrated flight-certifiable controls electronics EMRAX's motorsport-market BAMOCAR pairing doesn't carry, and a single unit already clears our 96 kW cruise floor. A second Evolito model, the **E1400**, is referenced in Evolito's own navigation/product list but no specifications were found this pass — flagged for a follow-up pull, not yet catalogued. **No public pricing found for either model** — Evolito's commercial motion right now is a single named OEM design-win (Electra) plus a type-certification submission, the same "quote-only, thin market" pattern this catalog has already documented for DeltaHawk/Turbotech/AantFarm (see [[motor-generator]] memory), and a company on a certification path prices accordingly — there is no basis to assume this becomes a cheap part. **Action: request a quote.** Not scored into a combo — no price exists to build one with — but added to the catalog as a tracked lead, and it is now the second named vendor (with H3X) relevant to trigger (b)/(c) below and to the standing open DG-004 voltage item (§0, line 15), since Evolito's bus voltage class is not yet confirmed against our HV bus assumption either.

### 11.5 DeltaHawk (Combo 7) — first real pricing signal, still not an official quote, but directionally closes the combo

Combo 7 (§ "not rankable — UNPRICED") has stood on "no public price exists" since v1. This pass found the first concrete numbers, though **neither is an official DeltaHawk vendor quote**: a forum account of an Oshkosh conversation with DeltaHawk (Oct 2025) reported **$120,000 (180 HP/DHK180) and $125,000 (200 HP/DHK200) for the firewall-forward kit alone** (engine + turbo/supercharger + cooling, excludes prop/governor/monitor/install — those add another ~$30–50k per the same thread), and a later forum post (May 2026) cites "prices I've seen suggested by DeltaHawk" near **$110,000** for a firewall-forward-with-prop package — consistent order of magnitude, not identical figures, both crowd-sourced rather than a company press release or written quote. These are DHK180/200 numbers, not the DHK235A4 this catalog's Combo 7 specifies, and DeltaHawk's own FAQ/pricing page did not return content this pass (403). **Read plainly: this doesn't formally price Combo 7, but it strongly confirms §7's original inference** ("FAA-TC'd piston engines of this class have historically priced well into six figures... which would disqualify it on cost alone") — a single DeltaHawk engine, any variant, appears to run at or above **2× this catalog's entire $50k whole-powertrain target by itself**, before the electric side, battery, or BOS are even added. Combo 7 stays formally "unscored, blocked on vendor quote" per this catalog's own evidence discipline, but the practical read is that an official DHK235A4 quote is very unlikely to change that combo's disposition — worth naming so this open item isn't read as more live than it is.

### 11.6 Position restated

**No viable ≤$50k answer today — unchanged.** AER-73 Package A (twin EMRAX 268, used/salvage, $57,200, 14% over $50k) remains the only live point on the frontier and the standing recommendation, already escalated to Elon/Bill on 2026-08-11 and still awaiting disposition (AER-56 parent still `todo`) plus Systems' DG-004 bus-voltage concurrence and R5 common-cause independence confirmation (both open, tracked on AER-73/AER-69, not duplicated here). Build-our-own gate: **not triggered** — a real, off-the-shelf, 14%-over path exists. **Process note:** the PR carrying last week's §11 pass ([MAOS-ICE PR #19](https://github.com/billmallard/MAOS-ICE/pull/19)) is still open, unmerged, unreviewed a week later — this pass's commits land on the same branch/PR rather than opening a new one, to avoid stacking unmerged market-watch PRs; flagging so the review backlog is visible, not silently absorbed.

**Re-evaluation triggers, updated:** (a) AER-73's open items close (DG-004 + R5) — nearest-term, unchanged; (b) the Hayabusa bench-endurance program produces a result; (c) H3X, Evolito, Duxion, Turbotech, or a comparable vendor publishes a sub-$15k/unit price at 90 kW+ continuous — **H3X is now the sharpest watch** (HPDM-250 continuous rating confirmed at 180 kW/18.7 kg, §11.3; only price is missing), Evolito newly added as a second named vendor to watch (§11.4); (d) DeltaHawk, AantFarm, or Turbotech publish an official vendor quote — DeltaHawk's informal pricing signal this pass (§11.5) makes a formal quote more useful to chase, not less, since it would let Combo 7 finally be scored (almost certainly negatively) rather than sitting unscored; (e) an APU or starter-generator vendor publishes a sub-100 kg, sub-$15k unit at ≥96 kW continuous electrical output (unchanged from 2026-08-23, nothing found this pass).
...
*Version 4 — 2026-08-23. Adds §11 (AER-59 weekly market-watch pass): closes Bill's 2026-08-11 APU/starter-generator lead, unaddressed through five prior weekly wakes — both product classes checked and sourced-negative against the 96 kW/155 kW floor (§11.1). Firms up Turbotech TP-R150 (104 kW confirmed, still unpriced) and H3X HPDM-500/250 figures (§11.2); neither changes the recommendation. Position restated unchanged: no ≤$50k answer today, AER-73 Package A ($57,200/14% over) stands as the escalated recommendation pending Elon/Bill disposition and open DG-004/R5 gates. Adds trigger (e) for a future APU/starter-generator vendor breakthrough.*
*Version 5 — 2026-08-30. Adds §11.3–11.5 (AER-59 weekly market-watch pass): resolves the HPDM-250 open item flagged in §11.2 — H3X's own post states 180 kW as continuous shaft power at 18.7 kg (9.6 kW/kg), clearing the 155 kW climb floor in one unit, still with no public price (§11.3). Adds Evolito E800 as a new tracked candidate — 110 kW continuous/28.3 kg, CAA type-certification submitted 2026-07-20 for Electra's EL9 — unpriced, action item to request a quote (§11.4). Surfaces the first concrete DeltaHawk pricing signal ($110k–$125k for a DHK180/200 firewall-forward kit, forum-sourced, not an official quote) — does not formally price Combo 7 (DHK235A4) but strongly confirms it already reads as ≥2× this catalog's whole-powertrain budget by itself (§11.5). None of the above changes the recommendation: AER-73 Package A ($57,200/14% over) stands, no combo crosses ≤$50k. Notes PR #19 (carrying §11) is still open/unreviewed a week later.*
