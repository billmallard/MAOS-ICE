...
### 11.3 Position restated

**No viable ≤$50k answer today — unchanged.** AER-73 Package A (twin EMRAX 268, used/salvage, $57,200, 14% over $50k) remains the only live point on the frontier and the standing recommendation, already escalated to Elon/Bill on 2026-08-11 and still awaiting disposition (AER-56 parent still `todo`) plus Systems' DG-004 bus-voltage concurrence and R5 common-cause independence confirmation (both open, tracked on AER-73/AER-69, not duplicated here). Build-our-own gate: **not triggered** — a real, off-the-shelf, 14%-over path exists.

**Re-evaluation triggers, updated:** (a) AER-73's open items close (DG-004 + R5) — nearest-term, unchanged; (b) the Hayabusa bench-endurance program produces a result; (c) H3X, Duxion, Turbotech, or a comparable vendor publishes a sub-$15k/unit price at 90 kW+ continuous — watch H3X specifically now that HPDM-500 is shipping in 2026; (d) DeltaHawk, AantFarm, or Turbotech publish pricing; **(e) new this pass — an APU or starter-generator vendor publishes a sub-100 kg, sub-$15k unit at ≥96 kW continuous electrical output.** Nothing found this pass is close (PBS Saphir tops out at ~40–60% of the cruise floor), but this closes the open loop on Bill's 2026-08-11 lead with a real trigger rather than silence.
